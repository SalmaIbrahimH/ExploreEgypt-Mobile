          ...
          child: Card(
            ...
            children: [
                ...
                child: Stack(
                    children: <Widget>[             
                      Positioned( top: 15,
                        ...
                        child: Icon(Icons.arrow_back,size: 42,color: Colors.white,) ),
                      Positioned(
                        top: 260,
                        right: 10,
                        left: 10,
              ...
              Container(child:Padding(
                ...
                child: Text(widget.article.description.toString(),   style: GoogleFonts.lato(
...
for(var i=0;i<widget.article.content.length;i++)
   Padding(
     ...
     child: Text(widget.article.content[i],style: GoogleFonts.lato(
                                            fontWeight: FontWeight.w600,
                                            color: Colors.black,
                                            fontSize: 15),),
   )
